...
# Copy certificate to release directory
...
RUN go build -tags musl -o datareplicationmetricsexpoter
...
RUN  mv ./datareplicationmetricsexpoter /usr/local/bin/app
...
CMD ["./datareplicationmetricsexpoter"]